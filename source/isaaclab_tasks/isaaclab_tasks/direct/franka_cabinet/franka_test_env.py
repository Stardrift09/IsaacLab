...
class FrankaTestEnvCfg(DirectRLEnvCfg):
    ...
    ketchup = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{root}/libero/COMMON/stable_hope_objects/ketchup/usd/ketchup.usd",
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
            articulation_props=sim_utils.ArticulationRootPropertiesCfg(
    ...
    basket = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{root}/libero/COMMON/stable_hope_objects/basket/usd/basket.usd",
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
            articulation_props=sim_utils.ArticulationRootPropertiesCfg(
                articulation_enabled=False
            )
    ...
    alphabet_soup = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{root}/libero/COMMON/stable_hope_objects/alphabet_soup/usd/alphabet_soup.usd",
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
            articulation_props=sim_utils.ArticulationRootPropertiesCfg(
                articulation_enabled=False
            )
    ...
    tomato_sauce = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{root}/libero/COMMON/stable_hope_objects/tomato_sauce/usd/tomato_sauce.usd",
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
            articulation_props=sim_utils.ArticulationRootPropertiesCfg(
                articulation_enabled=False
            )
...
class FrankaTestEnv(DirectRLEnv):
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        terminated = self._cabinet.data.joint_pos[:, 1] > 0.39
    ...
    def _compute_rewards(
        ...
        open_reward = cabinet_dof_pos[:, 1]  # drawer_top_joint
        ...
        rewards = torch.where(cabinet_dof_pos[:, 1] > 0.01, rewards + 0.25, rewards)
        rewards = torch.where(cabinet_dof_pos[:, 1] > 0.2, rewards + 0.25, rewards)
        rewards = torch.where(cabinet_dof_pos[:, 1] > 0.35, rewards + 0.25, rewards)
