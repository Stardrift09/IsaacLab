...
@configclass
class TestStageAsFeedbackCfg(DirectRLEnvCfg):
    # env
...
class TestStageAsFeedback(DirectRLEnv):
    ...
    cfg: TestStageAsFeedbackCfg

    def __init__(self, cfg: TestStageAsFeedbackCfg, render_mode: str | None = None, **kwargs):
        ...
        # ROBOT
        # trying to get from isaacsim is cumbersome # can't use wild card
        # prim = stage.GetPrimAtPath(f"/World/envs/env_.*/Robot")
        # for prim in stage.Traverse():
        #     print(prim.GetPath())
        # dir(something) gives all attributes and methods
