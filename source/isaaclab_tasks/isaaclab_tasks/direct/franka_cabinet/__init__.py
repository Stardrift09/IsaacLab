...
task_dict = { # Using the same config, manually set
    ...
    "TurnOnTheStove": "turn_on_the_stove",
    "OpenTheMicrowave": "open_the_microwave",
    "PickItUp": "pick_it_up",
    "PlaceInBasket": "place_in_basket",
    "PlaceInBasketUpright": "place_in_basket_upright",
    "PlaceInBasketDrop": "place_in_basket_drop",
    "PlaceInBasketNoGrasp": "place_in_basket_no_grasp",
